...
interface OrphageDetailsRouteParams {
  id: number,
}
...
export default function OrphanageDetails() {
  ...
  const params = route.params as OrphageDetailsRouteParams;
  ...
  function handleOpenGoogleMapRoutes(orphanage: Orphanage) {
  ...
  <Text style={styles.description}>{orphanage.about}</Text>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={() => handleOpenGoogleMapRoutes(orphanage)} style={styles.routesContainer}>
